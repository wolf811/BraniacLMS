# Generated by Django 3.2 on 2022-08-31 12:27
...
def forwards_func(apps, schema_editor):
    ...
    News.objects.create(
        ...
        тем, у кого нет возможности посещать курсы. Курс состоит из 7 встреч — одно занятие в неделю длительностью 3 часа.\r\nВстречи проводятся по воскресеньям с 14: 00.",
    )
    News.objects.create(
